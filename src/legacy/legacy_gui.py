"""Archived monolithic GUI containing retired standalone test dialogs.

The production application entry point is ``src/GUI.py``. This module is kept
for historical reference only and must not be imported by production code.
"""
...
def _install_global_crash_logging():
    ...
    _fatal_error_log = crash_log_path.open(
        "a",
        encoding="utf-8",
        buffering=1,
    )
...
try:
    ...
    HornbillVoltageCalibration = None
...
class MainWindow(QMainWindow):
    ...
    def initTabs(self):
        ...
        self.tab_widget.addTab(self.tab_SoftwareUpdate, "Software Update")
        ...
        QTimer.singleShot(
            2000,
            self.tab_SoftwareUpdate.check_automatically,
        )
    ...
    def TestListUI(self):
        ...
        # Title label
        title_label = QLabel("Voltage Calibration")
        ...
        # Description label
        desc_label = QLabel(
            "Select the reference DMM used for Hornbill voltage calibration. "
            "Other test dialogs are locked in this tab."
        )
        ...
        # Add select button
        select_btn = QPushButton("Open Selected Calibration")
    ...
    def _create_dialog_registry(self):
        ...
        registrations = (
            ...
            DialogRegistration("Voltage Calibration - 34470A", "Hornbill voltage calibration using a 34470A DMM", "voltage_calibration_34470a_dialog", VoltageCalibration34470ADialog),
            DialogRegistration("Hornbill Low Voltage Scope Capture", "Sweep Hornbill DIAG points and save one oscilloscope image per increment", "low_voltage_test_dialog", LowVoltageTestDialog),
            DialogRegistration("Hornbill Noise Test Voltage Sweep", "Sweep Hornbill voltage with SCPI and save one oscilloscope image per configured increment", "noise_voltage_sweep_dialog", NoiseVoltageSweepDialog),
