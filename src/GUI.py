...
class VoltageMeasurementDialog(QDialog):
    ...
    def __init__(self):
        ...
        self.output_file = r"C:\Users\shamlee3\OneDrive - Keysight Technologies\Wei Jing See's files - Shamman Xian Jun Lee\Test Data\Monk Data_Voltage Accuracy.xlsx"  
