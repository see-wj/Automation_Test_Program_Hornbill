...
TEXT_EDITED_BINDINGS = (
    ...
    ("QLineEdit_SweepPoints", "SweepPoints_changed"),
    (
        "QLineEdit_External_Source_Positive_Current_Limit",
        "External_Source_Positive_Current_Limit_changed",
    ),
    (
        "QLineEdit_External_Source_Negative_Current_Limit",
        "External_Source_Negative_Current_Limit_changed",
    ),
    ("QLineEdit_Sink_Slew_Rate", "Sink_Slew_Rate_changed"),
    ("QLineEdit_Sinking_Initial_Voltage", "Sinking_Initial_Voltage_changed"),
    ("QLineEdit_Sinking_Final_Voltage", "Sinking_Final_Voltage_changed"),
    ("QLineEdit_Sinking_Voltage_Step_Size", "Sinking_Voltage_Step_Size_changed"),
...
CURRENT_TEXT_BINDINGS = (
    ...
    (
        "QLineEdit_External_Source_VisaAddress",
        "External_Source_VisaAddress_changed",
    ),
...
STATE_CHANGED_BINDINGS = (
    ...
    ("QCheckBox_Blynk_Widget", "checkbox_state_Blynk"),
    ...
    ("QCheckBox_Sinking_Test_Widget", "sinking_test_changed"),
